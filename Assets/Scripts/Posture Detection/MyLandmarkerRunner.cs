...
{
    public class MyLandmarkerRunner : VisionTaskApiRunner<PoseLandmarker>
    {
        ...
        public PoseLandmarkerOptions options;
        ...
        public void changeOptions(int idx)
        {
            Tasks.Vision.Core.RunningMode mode = Tasks.Vision.Core.RunningMode.LIVE_STREAM;
            switch (idx)
            {
                case 1:
                    mode = Tasks.Vision.Core.RunningMode.LIVE_STREAM;
                    break;
                case 2:
                    mode = Tasks.Vision.Core.RunningMode.VIDEO;
                    break;
                case 3:
                    mode = Tasks.Vision.Core.RunningMode.IMAGE;
                    break;
                default:
                    break;
            }
