...
public class ScoreRow : MonoBehaviour
{
    ...
    public void initRow(int i, bool arrow6, ScoreNotesManager scoreNotesManager)
    {
        ...
        {
            arrow1Btn.onClick.AddListener(() => { scoreNotesManager.selectCell(i, 0); });
            arrow2Btn.onClick.AddListener(() => { scoreNotesManager.selectCell(i, 1); });
            arrow3Btn.onClick.AddListener(() => { scoreNotesManager.selectCell(i, 2); });
        }
    }
